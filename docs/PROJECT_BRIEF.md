        ...
        bitvec exists to solve a narrow, inspectable developer-tooling problem:
        Compact bit vector with set operations, slicing, and packed storage. Zero dependencies.
        ...
        Topics: bit-manipulation, bit-vector, bitset, data-structures, python, zero-dependencies
